...
public class ControllerEventsListener : MonoBehaviour
{
    ...
    static float triggerAxis;
    bool isGrabbing;

    private void Update()
    {
        //triggerAxis = controllerEvents.GetTriggerAxis();
        //handAnimator.playbackTime = 15.0f;
        //handAnimator.Play();//Mathf.Lerp(0.0f, 24.0f, triggerAxis);
        //print(controllerEvents.GetTriggerAxis().ToString());
    }
    ...
    {
        //DebugLogger(e.controllerIndex, "APPLICATION MENU", "pressed", e);
    }
