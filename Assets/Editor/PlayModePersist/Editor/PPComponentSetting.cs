...
public class PPComponentSetting
{
    ...
    private bool isComponentObjectNull = true; //due to really lame Unity 4.3 bug where ComponentObject sometimes equals null even if it isn't
    ...
    public Component RestoreSettings()
    {
        ...
        /* //replace this because of lame Unity 4.3 bug
