...
-------------------------
- Fixed Unity 4.3 compatibility issue
...
Q: PlayModePersist window won't open, even after clicking Window->PlayModePersist
A: There is a rare issue where Unity will open a Window and hide it, so you are unable to see it. If this happens simply change your layout (dropdown top-left of the editor) and try again.
